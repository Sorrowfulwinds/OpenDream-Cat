...
public sealed partial record DreamFilterAlpha : DreamFilter {
    [ViewVariables, DataField] public float X;
    [ViewVariables, DataField] public float Y;
    [ViewVariables, DataField] public int Icon; // Icon resource ID
    [ViewVariables, DataField("render_source")] public string RenderSource = ""; // String that gets special processing in the render loop
    [ViewVariables, DataField] public short Flags;
}
...
public sealed partial record DreamFilterAngularBlur : DreamFilter {
    [ViewVariables, DataField] public float X;
    [ViewVariables, DataField] public float Y;
    [ViewVariables, DataField] public float Size = 1f;
}

[Serializable, NetSerializable]
public sealed partial record DreamFilterBloom : DreamFilter {
    [ViewVariables, DataField] public Color Threshold = Color.Black;
    [ViewVariables, DataField] public float Size = 1f;
    [ViewVariables, DataField] public float Offset = 1f;
    [ViewVariables, DataField] public float Alpha = 255f;
}
...
public sealed partial record DreamFilterColor : DreamFilter {
    [ViewVariables, DataField(required: true)] public ColorMatrix Color;
    [ViewVariables, DataField] public float Space; // Default is FILTER_COLOR_RGB = 0
}
...
public sealed partial record DreamFilterDropShadow : DreamFilter {
    [ViewVariables, DataField] public float X = 1f;
    [ViewVariables, DataField] public float Y = -1f;
    [ViewVariables, DataField] public float Size = 1f;
    [ViewVariables, DataField] public float Offset;
    [ViewVariables, DataField] public Color Color = Color.Black.WithAlpha(128);
}
...
public sealed partial record DreamFilterLayer : DreamFilter {
    ...
    [ViewVariables, DataField] public int Icon; // Icon resource ID
    [ViewVariables, DataField("render_source")] public string RenderSource = ""; // String that will require special processing
    [ViewVariables, DataField] public float Flags; // Default is FILTER_OVERLAY = 0
    [ViewVariables, DataField] public Color Color = Color.Black.WithAlpha(128); // Shit needs to be string or color matrix, because of course one has to be special
    [ViewVariables, DataField] public Matrix3x2 Transform = Matrix3x2.Identity;
...
public sealed partial record DreamFilterOutline : DreamFilter {
    [ViewVariables, DataField] public float Size = 1f;
    [ViewVariables, DataField] public Color Color = Color.Black;
    [ViewVariables, DataField] public float Flags;
}
...
public sealed partial record DreamFilterRadialBlur : DreamFilter {
    [ViewVariables, DataField] public float X;
    [ViewVariables, DataField] public float Y;
    [ViewVariables, DataField] public float Size = 0.01f;
}
...
public sealed partial record DreamFilterRays : DreamFilter {
    [ViewVariables, DataField] public float X;
    [ViewVariables, DataField] public float Y;
    [ViewVariables, DataField] public float Size = 16f; // Defaults to half tile width
    [ViewVariables, DataField] public Color Color = Color.White;
    [ViewVariables, DataField] public float Offset;
    [ViewVariables, DataField] public float Density = 10f;
    [ViewVariables, DataField] public float Threshold = 0.5f;
    [ViewVariables, DataField] public float Factor;
    [ViewVariables, DataField] public float Flags = 3f; // Defaults to FILTER_OVERLAY | FILTER_UNDERLAY
}
...
public sealed partial record DreamFilterRipple : DreamFilter {
    ...
    [ViewVariables, DataField] public float Y;
    [ViewVariables, DataField] public float Size = 1f;
    [ViewVariables, DataField] public float Repeat = 2f;
    [ViewVariables, DataField] public float Radius;
    [ViewVariables, DataField] public float Falloff = 1f;
    [ViewVariables, DataField] public float Flags;
}
